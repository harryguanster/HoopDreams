...
const GAMES: Game[] = [
  ...
  {
    href: "/start-bench-cut", tag: "Opinion", title: "Start, Bench, Cut",
    description: "Jordan vs Kobe vs LeBron — who starts, who rides pine, who gets cut? Two eras.",
    meta: `${TRIOS.length + CURRENT_TRIOS.length} rounds · All-time & 2025–26`,
    playerId: 2544, playerPos: "top center", category: "games",
  },
  {
    href: "/guess-who", tag: "Puzzle", title: "Guess Who",
    description: "Decode a mystery player from stat clues — legends or current stars.",
    meta: `302 all-time + ${CURRENT_NBA_PLAYERS.length} current · 10 guesses`,
    playerId: 977, playerPos: "top center", category: "games",
  },
  {
    href: "/stat-line-guesser", tag: "Stats", title: "Stat Line Guesser",
...
const SHOWCASE_GAMES: ShowcaseGame[] = [
  {
    href: "/start-bench-cut", tag: "Opinion",
    title: "Start · Bench · Cut", description: "Jordan, Kobe, LeBron or Jokic, Wemby, SGA — who starts, who rides pine, who gets cut? Two eras, over a hundred impossible trios.",
    meta: `${TRIOS.length + CURRENT_TRIOS.length} rounds · All-time & 2025–26`,
    accentColor: "#f97316",
    Scene: (p) => <SBCScene era="alltime" {...p} />,
  },
  {
    href: "/guess-who", tag: "Puzzle",
    title: "Guess · Who", description: "Decode a mystery player from Wordle-style stat clues — legends or current stars. Green = exact match, yellow = close.",
    meta: `302 all-time + ${CURRENT_NBA_PLAYERS.length} current · 10 guesses`,
    accentColor: "#a855f7",
    Scene: (p) => <GuessWhoScene era="alltime" {...p} />,
  },
  {
    href: "/stat-line-guesser", tag: "Stats",
    title: "Stat · Line", description: "One clue at a time, a stat line is revealed — choose all-time greats or current stars. Name the player before all five clues drop.",
    meta: `${STAT_LINE_PLAYERS.length + CURRENT_STAT_LINE_PLAYERS.length} players · 5 reveals`,
    accentColor: "#10b981",
